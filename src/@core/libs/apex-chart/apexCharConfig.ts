  ...
  return {
    ...
    plotOptions: {
      heatmap: {
        ...
        colorScale: {
          ranges: [
            { to: 10, from: 0, name: '0-10', color: '#F44336' },
            { to: 20, from: 11, name: '10-20', color: '#2196F3' },
            { to: 30, from: 21, name: '20-30', color: '#4CAF50' },
            { to: 40, from: 31, name: '30-40', color: '#FFEB3B' },
            { to: 50, from: 41, name: '40-50', color: '#795548' },
            { to: 60, from: 51, name: '50-60', color: '#9E9E9E' },
          ],
        },
      },
    },
