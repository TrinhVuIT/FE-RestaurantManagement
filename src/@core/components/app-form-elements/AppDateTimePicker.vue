...
compAttrs.config.dateFormat = 'd/m/Y'
...
if (compAttrs.config && compAttrs.config.enableTime) {
  compAttrs.config.enableSeconds = true
  compAttrs.config.time_24hr = true
  compAttrs.config.dateFormat = 'd/m/Y H:i:s'
}
